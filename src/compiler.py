...
for type_name in Type.types.keys():
    Type.add_op(type_name, Operation(type_name, op_start_input_sig), TypeSignature([TWordDefinition],[TWordDefinition,TInputTypeSignature]), WordFlags(), "WordDefinition")
    Type.add_op(type_name, Operation(type_name, op_continue_input_sig), TypeSignature([TInputTypeSignature],[TInputTypeSignature]), WordFlags(), "InputTypeSignature")  
    Type.add_op(type_name, Operation(type_name, op_output_sig), TypeSignature([TOutputTypeSignature],[TOutputTypeSignature]), WordFlags(), "OutputTypeSignature")          
