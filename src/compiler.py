...
def op_start_input_sig(s: Stack) -> None:
    """
    WordDefinition -> WordDefinition, InputTypeSignature.
...
def op_output_sig(s: Stack) -> None:
    """
    OutputTypeSignature -> OutputTypeSignature.
...
def op_switch_to_output_sig(s: Stack) -> None:
    """
    WordDefinition, InputTypeSignature -> OutputTypeSignature.
...
Type.add_op(Operation('->',op_switch_to_output_sig), TypeSignature([TWordDefinition, TInputTypeSignature],[TOutputTypeSignature]), WordFlags(), "InputTypeSignature")


def op_skip_to_output_sig(s: Stack) -> None:
    """
    WordDefinition -> OutputTypeSignature.
...
def op_start_code_compile(s: Stack) -> None:
    """
    WordDefinition, OutputTypeSignature -> CodeCompile.
...
Type.add_op(Operation(';',op_start_code_compile), TypeSignature([TWordDefinition, TOutputTypeSignature],[TCodeCompile]), WordFlags(), "OutputTypeSignature")


def op_skip_to_code_compile(s: Stack) -> None:
    """
    WordDefinition -> CodeCompile.
